...
class NeosdkTest < Test::Unit::TestCase
  def setup
    @gateway = NeosdkGateway.new(some_credential: 'login', another_credential: 'password')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_neosdk_test.rb \
